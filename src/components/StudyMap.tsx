...
import { Book, Anchor, Droplets, Wallet, Scale, HardHat, Calendar, BookOpen, Swords } from "lucide-react";
...
const ZONES = [
    ...
    { id: "LIB", title: "Gran Biblioteca", icon: BookOpen, color: "from-amber-500/20 to-yellow-900/20", border: "border-amber-500/50", href: "/library" },
    { id: "DOJO", title: "El Dojo", icon: Swords, color: "from-red-500/20 to-rose-900/20", border: "border-red-500/50", href: "/dojo" }, // New Dojo Card
